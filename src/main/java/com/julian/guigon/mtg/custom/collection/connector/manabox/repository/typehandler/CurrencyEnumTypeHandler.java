...
public class CurrencyEnumTypeHandler extends BaseTypeHandler<CurrencyEnum> {
	...
	@Override
	public CurrencyEnum getNullableResult(ResultSet rs, String columnName)
			throws SQLException {
		return CurrencyEnum.fromString(rs.getString(columnName));
	}

	@Override
	public CurrencyEnum getNullableResult(ResultSet rs, int columnIndex)
			throws SQLException {
		return CurrencyEnum.fromString(rs.getString(columnIndex));
	}

	@Override
	public CurrencyEnum getNullableResult(CallableStatement cs, int columnIndex)
			throws SQLException {

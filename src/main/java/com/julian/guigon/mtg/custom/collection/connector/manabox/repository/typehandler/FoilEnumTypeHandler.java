...
public class FoilEnumTypeHandler extends BaseTypeHandler<FoilEnum> {
	...
	@Override
	public FoilEnum getNullableResult(ResultSet rs, String columnName)
			throws SQLException {
		return FoilEnum.fromString(rs.getString(columnName));
	}

	@Override
	public FoilEnum getNullableResult(ResultSet rs, int columnIndex)
			throws SQLException {
		return FoilEnum.fromString(rs.getString(columnIndex));
	}

	@Override
	public FoilEnum getNullableResult(CallableStatement cs, int columnIndex)
			throws SQLException {
